  ...
  return (
    <nav 
      ...
      className={`fixed top-6 left-1/2 -translate-x-1/2 z-50 transition-all duration-500 ease-out flex items-center justify-between px-6 py-3 rounded-full ${
        scrolled || location.pathname !== '/' ? 'w-[90%] max-w-5xl bg-background/80 backdrop-blur-xl border border-dark/10 shadow-lg text-dark' : 'w-full max-w-7xl text-primary bg-transparent'
      }`}
    >
