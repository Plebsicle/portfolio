...
const Footer = () => {
  return (
    <footer className="bg-dark text-primary rounded-t-[4rem] pt-32 pb-12 px-8 md:px-16 mt-[-4rem] relative z-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 mb-24">
        ...
        <div className="grid grid-cols-2 gap-8 text-sm font-mono">
          <div className="flex flex-col gap-4">
            <span className="text-primary/50 mb-2">CONNECT</span>
          ...
          <div className="flex flex-col gap-4">
            <span className="text-primary/50 mb-2">NAVIGATION</span>
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center border-t border-primary/10 pt-8 gap-6">
        <div className="font-sans font-bold text-xl">Praval H. Parikh</div>
        <div className="flex items-center gap-3 bg-primary/5 rounded-full px-4 py-2 border border-primary/10">
          <div className="w-2.5 h-2.5 rounded-full bg-green-500 animate-pulse"></div>
          <span className="font-mono text-xs text-primary/80">SYSTEM OPERATIONAL</span>
        </div>
